...
def index(request):
    branch = {'MBA(HR)':1,'MBA(Finance)':2,'Geology':3,'Geophysics':4,'MSc. - Chemistry':5,'Mech.Engineering':6,
              'Petroleum Engineering':7,'Electrical Engineering':8,'Chem.Engineering':9,'Civil Engineering':10,
              'BE / BTech - Computer Science':11,'BE / BTech - IT':12,'BE / BTech Electronics. & Telecommunication':13,'Law':14,
